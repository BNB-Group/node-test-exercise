...
const mortgageService = __importStar(require("../services/mortgage.service"));
function calculateMonthlyPayment(req, res) {
    const { loanAmount, annualInterestRate, termYears, type, offsetAmount, addons } = req.body;
